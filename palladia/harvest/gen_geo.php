...
$sql="SELECT id, qwd,  P18, nb, nbimg, lat, lon from p189 WHERE qwd!=0 AND level=0 AND lat!='' AND nbimg!=0";
...
$sql="SELECT id,  P18, qwd, nb, nbimg, lat, lon from p1071 WHERE qwd!=0 AND lat!='' AND nbimg!=0";
mysqli_query($link,"SET NAMES 'utf8'");
$rep=mysqli_query($link,$sql);
$cpt=0;
$txt="";
