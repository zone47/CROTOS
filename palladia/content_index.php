...
while($data = mysqli_fetch_assoc($rep)) {
	...
	$discov_place=txt_prop($id_artw,189,$l);
	$fabric_place=txt_prop($id_artw,1071,$l);
	
	$fabric_method=txt_prop($id_artw,2079,$l);
	$culture=txt_prop($id_artw,2596,$l);
	$inscription=inscript($id_artw,$l);
	$tab3d=link3D($id_artw);
	...
	if (count($tab3d)>0){
		if ($disp==0)
			...
			$img3d="3d_ico_day.png";
		$cartel.=" <a href=\"https://commons.wikimedia.org/wiki/File:".$tab3d[0]."\" title=\"".translate($l,"4896")."\"><img src=\"../img/".$img3d."\" alt=\"\"/></a>";
		$yox_links.=" <a href=\"https://commons.wikimedia.org/wiki/File:".$tab3d[0]."\" title=\"".translate($l,"4896")."\"><img src=\"../img/".$img3d."\" alt=\"\"/></a>";
	}
	if ($data['P347']!="")
		$cartel.=" <a href=\"https://www.pop.culture.gouv.fr/notice/joconde/".$data['P347']."\"><img src=\"../img/joconde_ico.png\" alt=\"\"/></a>";
	if ($described_link!=""){
	...
	$url="/crotos/palladia/?q=".$qwd_art;	
	/*if ($disp==0)
		$cartel.="\n <a href=\"".$url."\" title=\"Palladia\"><img src=\"img/palladia_ico.png\" alt=\"Palladia\" title=\"Palladia\"/></a>";
	else
		$cartel.="\n <a href=\"".$url."\" title=\"Palladia\"><img src=\"img/palladia_ico.png\" alt=\"Palladia\" title=\"Palladia\"/></a>";*/
	
	$cartel_links="\n				<div class=\"liens\">";
	if ($described_link!="")
		$cartel_links.="<p><a href=\"".$described_link."\" title=\"".translate($l,"973")."\"><img src=\"../img/li,k973.png\" alt=\"Europeana\"/></a> <a href=\"".$described_link."\" title=\"".translate($l,"973")."\">".translate($l,"973")."</a></p>";
	/*if ($loc_link!="")
		$cartel_links.="\n<p>".$loc_link."</p>";*/
	if ($data['P727']!=""){
	...
	if ($data['P347']!=""){
		$cartel_links.="<p><a href=\"https://www.pop.culture.gouv.fr/notice/joconde/".$data['P347']."\"><img src=\"../img/joconde.png\" alt=\"Joconde\"/></a> <a href=\"https://www.pop.culture.gouv.fr/notice/joconde/".$data['P347']."\" class=\"externe\">".translate($l,"Joconde")."</a></p>";
		$yox_links.=" <a href=\"https://www.pop.culture.gouv.fr/notice/joconde/".$data['P347']."\" title=\"".translate($l,"Joconde")."\"><img src=\"../img/joconde_ico.png\" alt=\"Joconde\"/></a>";
	}
	if ($data['P1212']!=""){
	...
	if (count($tab3d)>0){
		for ($i=0;$i<count($tab3d);$i++){
			$cartel_links.="<p><a href=\"https://commons.wikimedia.org/wiki/File:".$tab3d[$i]."\"><img src=\"../img/3d.png\" alt=\"Commons\"/></a> <a href=\"https://commons.wikimedia.org/wiki/File:".$tab3d[$i]."\" class=\"externe\">".translate($l,"4896")."</a></p>";
		//$yox_links.=" <a href=\"https://commons.wikimedia.org/wiki/File:".$tab3d[$i]."\" title=\"".translate($l,"4896")."\"><img src=\"../img/3d_view.png\" alt=\"Commons\"/></a>";
	...
	$url="/crotos/palladia/?q=".$qwd_art; 
	$cartel_links.="\n<p> <a href=\"".$url."\"><img src=\"img/palladia.png\" alt=\"Palladia\"/></a> <a href=\"".$url."\">palladia/?q=".$qwd_art."</a></p>";
	//$yox_links.=" <a href=\"".$url."\" title=\"Palladia URL\"><img src=\"img/palladia_view.png\" alt=\"Palladia\"/></a>";
	...
	if ($txtdim_cart!=""){
		$cartel.="\n<p>".$txtdim_cart."</p>";
		$yox_cartel.="&nbsp;&nbsp;|&nbsp;&nbsp;".$txtdim_yox;
	}
	if ($inscription!=""){
		$cartel.="\n<p>".$inscription."</p>";
		$yox_cartel.="&nbsp;&nbsp;|&nbsp;&nbsp;".$inscription;
	}
