...
;(function($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		init: function() {
			...
			$this.wrap("<span style='position:inherit;' class='add-clear-span'></span>");
			$this.after($("<a href='#clear' id='close_link' style='display: none;font-size:140%;'>" + options.closeSymbol + "</a>"));
			$this.next().css({
				color: options.color,
