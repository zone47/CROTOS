...
/* / */
$cosmos=1;
$tab_facets=array(31,170,136,195,921,180,1433);
$prop=31;
if (isset($_GET['f']))
	if ($_GET['f']!="31") 
		$prop=intval($_GET['f']);
...
$(function(){
	$('#topic_title').autoComplete({
		...
		renderItem: function (item, search){
			...
			return '<div class="autocomplete-suggestion"  data-val="/crotos/dwynwen/?' + data + '" title="'+item.replace( /<.*?>/g, '' )+'">'+ item + '</div>';
		}
	});
...
<?php
	...
	include "../../cosmos/content_cosmos.php";
