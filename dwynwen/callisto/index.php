...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="/crotos/dwynwen/favicon.ico" />
    <title>Dwynwen - Callisto</title>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a href="/crotos/dwynwen/"  class="navbar-brand" id="ico_crotos"><img src="assets/img/crotos_med.jpg" /></a><span class="navbar-brand" id="cal_title"> <a href="/crotos/dwynwen/">Dwynwen</a> – <a href="/crotos/dwynwen/callisto"><?php 
if ($l=="fr")
	echo "Carte";
else
	echo "Map";
  ...
  depicts.eachLayer(function (layer) {
    if (map.hasLayer(depictLayer)) {
      if (map.getBounds().contains(layer.getLatLng())) {
		$("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/depicts.png"></td><td>'+ layer.feature.properties.l + ' <span class="nb">(<span class="feature-name depicts">' + layer.feature.properties.n + '</span>)</span></td><td style="vertical-align: middle;"><a href="/crotos/dwynwen/?p180=' + layer.feature.properties.q + '"><img src="assets/img/crotos_ico.png" alt="" /></a></td></tr>');
      }
    }
  });
<?php break;
...
?>
  museums.eachLayer(function (layer) {
    if (map.hasLayer(museumLayer)) {
      if (map.getBounds().contains(layer.getLatLng())) {
        $("#feature-list tbody").append('<tr class="feature-row" id="' + L.stamp(layer) + '" lat="' + layer.getLatLng().lat + '" lng="' + layer.getLatLng().lng + '"><td style="vertical-align: middle;"><img width="16" height="18" src="assets/img/museum.png"></td><td>'+ layer.feature.properties.l + ' <span class="nb">(<span class="feature-name">' + layer.feature.properties.n + '</span>)</span></td><td style="vertical-align: middle;"><a href="/crotos/dwynwen/?p195=' + layer.feature.properties.q + '"><img src="assets/img/crotos_ico.png" alt="" /></a></td></tr>');
      }
    }
  });
<?php break;
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
	  ...
	  if (feature.properties.t!=""){
		content = content + "<tr><td><a href=\"/crotos/dwynwen/?p180=" + layer.feature.properties.q + "\"><img src=\"" + layer.feature.properties.t + "\" /></a>";
      ...
      content = content + "<tr><td><a href=\"/crotos/dwynwen/?p180=" + layer.feature.properties.q + "\">" + feature.properties.n + " ";
	  if (feature.properties.n==1)
	    content = content + result;
	  else
	    content = content + results;
	  content = content + "</a> <a href=\"/crotos/dwynwen/?p180=" + layer.feature.properties.q + "\"><img src=\"assets/img/crotos_ico.png\" alt=\"\" /></a></td></tr>";
...
var museums = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
	  var content = "<table class='table table-striped table-bordered table-condensed snipet'>" + "<tr><td><a href=\"http://tools.wmflabs.org/reasonator/?lang=" + l + "&q=" + layer.feature.properties.q + "\">" + layer.feature.properties.l + "</a> <a href=\"http://tools.wmflabs.org/reasonator/?lang=" + l + "&q=" + layer.feature.properties.q + "\"><img src=\"assets/img/reas_ico.png\" alt=\"\" /></a></td></tr>";
	  if (feature.properties.t!=""){
		content = content + "<tr><td><a href=\"/crotos/dwynwen/?p195=" + layer.feature.properties.q + "\"><img src=\"" + layer.feature.properties.t + "\" /></a>";
		content = content + " <a href=\"https://commons.wikimedia.org/wiki/File:" + layer.feature.properties.i + "\"><img src=\"assets/img/commons_ico.png\" class=\"cms_ico\"/></a></td></tr>";
		
	  }
      content = content + "<tr><td><a href=\"/crotos/dwynwen/?p195=" + layer.feature.properties.q + "\">" + feature.properties.n + " ";
	  if (feature.properties.n==1)
	    content = content + result;
	  else
	    content = content + results;
	  content = content + "</a> <a href=\"/crotos/dwynwen/?p195=" + layer.feature.properties.q + "\"><img src=\"assets/img/crotos_ico.png\" alt=\"\" /></a></td></tr>";
