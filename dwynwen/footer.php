<footer <?php if ($num_rows<6) echo "class=\"marge\"" ?>>
	<span class="bl_foot"><a href="https://twitter.com/shona_gon">/* / */</a>, <a href="https://twitter.com/wiki_nlw">J.E.</a>&nbsp;&nbsp;–<!--&nbsp;&nbsp;<a href="/dozo/<?php if ($l=="fr") echo "crotos-moteur-de-recherche-sur-les-oeuvres-dart-dans-wikidata"; else echo "crotos-a-project-on-visual-artworks-powered-by-wikidata-and-wikimedia-commons"; ?>" class="externe">info [<?php if ($l=="fr") echo "fr"; else echo "en"; ?>]</a>,--> <a href="https://github.com/zone47/CROTOS" class="externe">source</a>, <a href="/crotos/dwynwen/bdd/dwynwen.sql.zip">data</a><a href="http://creativecommons.org/publicdomain/zero/1.0/" title="CC0 1.0 Universal"><img src="/crotos/img/licence/CC-0-icon.png" alt="CC0 1.0 Universal" class="licence"></a>–&nbsp;unofficially powered by</span><span class="sep"> </span>
    <span class="bl_foot"><a href="https://www.library.wales/" title="Llyfrgell Genedlaethol Cymru - National Library of Wales" ><img src="/crotos/dwynwen/img/llgc-nlw.png" alt="Llyfrgell Genedlaethol Cymru - National Library of Wales" /></a> <a href="http://www.wikidata.org" title="<?php echo translate($l,"Wikidata"); ?>"><img src="/crotos/img/wikidata.png" alt="<?php echo translate($l,"Wikidata"); ?>"/></a>  <a href="http://commons.wikimedia.org" title="<?php echo translate($l,"Commons"); ?>"><img src="/crotos/img/wikimedia-commons.png" alt="<?php echo translate($l,"Commons"); ?>" /></a>  <img src="/crotos/img/semanticpedia.png" alt="Sémanticpédia" />    <img src="/crotos/img/photographer.png" alt="Photographers" />  al.</span>
