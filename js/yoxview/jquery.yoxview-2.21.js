...
(function($){
    ...
    function YoxView()
    {
        ...
        var defaults = {
            ...
            controlsInitialFadeTime: 500, // The time, in milliseconds, it takes the menu and prev/next buttons to fade in and out when the popup is opened.
            controlsInitialDisplayTime: 1500, // The time, in milliseconds, to display the menu and prev/next buttons when the popup is opened. Set to 0 to not display them by default
            ...
            infoBackColor: "#070707",
            infoBackOpacity: 0.98,
            ...
            titleAttribute: "data-credit", // The attribute of an img used for the text in YoxView. Use either "title" or "alt".
            titleDisplayDuration: 1000, // The time in ms to display the image's title, after which it fades out.
			dataNotice: "data-notice" // The attribute of an img used for the text in YoxView. Use either "title" or "alt".
        };
        ...
        function getAllowedThumbnailsSelector(options){
            return "a.yox:has(img)" + (options.textLinksSelector !== null ? ",a" + options.textLinksSelector : "");
        }
        ...
        var supportedTypes = {
            image: function(thumbnail, thumbnailHref, thumbImg, options)
            {
                ...
                for(var i=0; i<options.allowedImageUrls.length && !imageData; i++)
                {
                    ...
                    {
                        imageData = {
                            src: thumbnail.attr("data-file"),
                            title:thumbImg.attr(options.titleAttribute),
							notice:thumbImg.attr(options.dataNotice),
...
/* / */		   
        ...
        function createMenuButton(_title, btnFunction, stopPlay)
        {
			...
			if (btnFunction=="close")
				var btn = $("<a>", {
					href : "#",
					title: options.close_popin,//currentLanguage.Close,
					click : function(){
        ...
        function createPopup()
        {
            ...
            if (options.renderInfo !== false)
            {
                ...
                if (singleImage)
                {
                    infoNotice.css("margin-left", "10px");
				...
				infoPanelContent.append(infoNotice);
        ...
        function setInfoPanelHeight(callback)
        {
			...
			var infoTextHeight = infoText.outerHeight()+10;
			if (infoTextHeight<47)
				infoTextHeight=47;
            var titleHeight = infoNotice.outerHeight()+infoTextHeight;
	        ...
	        if (infoPanel)
            {
				...
				if (infoPanelLink)
                {
					...
					if (urlimg!=""){
						...
						var tabsrc = media.src.split("/");
						if (typeof tabsrc[8] == "undefined")
							urlimg = "https://commons.wikimedia.org/wiki/File:"+tabsrc[7];
						else
							urlimg = "https://commons.wikimedia.org/wiki/File:"+tabsrc[8];
